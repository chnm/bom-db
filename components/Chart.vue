...
// This component builds a barchart for the API.
// It is a Vue component, so it is a function that returns a Vue component.
// The function takes a single argument, which is an object with the properties
// that are used in the component.
